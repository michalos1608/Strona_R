...
```
Wnioski : 
-Najwyższą średnią długością życia charakteryzują się mieszkańcy Oceanii oraz Europy. 
-Afryka wypada najgorzej w zestawieniu, ze średnią znacząco odbiegającą od pozostałych kontynentów.
...
```
Wnioski : 
-Im bogatszy kraj, tym statystycznie dłuższe życie jego mieszkańców.
-Najdynamiczniejszy wzrost długości życia następuje przy przejściu z bardzo niskiego do średniego poziomu zamożności.
#
#
### Wykres 3
```{r}
...
```
Wnioski : 
-Europa i Oceania mają najwyższą medianę PKB
-Wykres boxplot ujawnia stopień nierówności ekonomicznych wewnątrz kontynentów.
