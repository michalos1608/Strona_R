...
W tej analizie wykorzystujemy zbiór danych `gapminder`. Zawiera on statystyki dotyczące krajów z całego świata, obejmujące:
* **PKB na osobę** (gdpPercap),
* **Oczekiwaną długość życia** (lifeExp),
* **Populację** (pop).
